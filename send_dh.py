...
#    pkt1 = desc_hdr(vdp_id=10) / in_ether / IP(src=addr,dst=addr1) / "hi"
    if sel==1:
        ...
        pkt6 = Ether(src=get_if_hwaddr(iface), dst='00:00:00:00:00:01', type=0x800) / IP(version=4, proto=6) / TCP() / ""   
        print "sending TRE_test packet"
        pkt6.show()
        hexdump(pkt6)
        sendp(pkt6, iface=iface, verbose=False)
        #tre_test_hdr(count=0, bitmap=0) 
    elif sel==7:
        pkt7 = Ether(src=get_if_hwaddr(iface), dst='00:00:00:00:00:01', type=0x800) / IP(version=4, proto=6) / TCP() / ""   
        print "sending TRE_test packet"
        pkt7.show()
        hexdump(pkt7)
        sendp(pkt7, iface=iface, verbose=False)
